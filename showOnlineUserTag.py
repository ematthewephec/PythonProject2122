...
userlist=[{'userid':1, 'tag':['1T','ActivUser','python']},{'userid':2, 'tag':['2T','ActivUser']}] #exemple de liste de user recevable par la fonction
helpShowOnlineUserTag = HelpCommand("cette commande ne prend pas d'argument et renvoie un grahique en batonnets du nombre de personne par tag ")
